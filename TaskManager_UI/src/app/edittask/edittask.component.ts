...
export class EdittaskComponent implements OnInit {
  ...
  constructor(private taskService: TaskserviceService, private taskRouter: Router, private activeRoute: ActivatedRoute) {    
    ...
    this.taskModel.ParentTask = new ParentTaskModelModule;
    console.log("Log edit task 1 ")      
    this.activeRoute.queryParams.subscribe(params => { 
      console.log("Log edit task 2");
      console.log(params);      
      console.log(params["TaskModelModule.TaskDescripton"]);
    //   if (parms.has("id")) {
